...
/* Terms of Purchase, transcribed from the client's "TERMS OF PURCHASE.docx"
   in 6. QUIZ / 6. CHECK OUT PAGE. Applies to the $35 Action Plan only. */
export const termsOfPurchase: LegalDoc = {
  title: "Terms of Purchase",
  lastUpdated: "The Visibility Codes Personalised Action Plan",
  sections: [
    {
      heading: "About these terms",
      blocks: [
        { kind: "p", text: "By proceeding with your purchase, you acknowledge that you have read, understood and agree to these Terms of Purchase." },
        { kind: "p", text: "These Terms apply to your purchase of The Visibility Codes Personalised Action Plan by Katrina Kavvalos." },
      ],
    },
    {
      heading: "What’s Included",
      blocks: [
        { kind: "p", text: "Your purchase includes your personalised Visibility Codes Action Plan, based on the results of your Visibility Codes assessment." },
        { kind: "p", text: "Your Action Plan is designed to help you understand what may be limiting your visibility and what to focus on next." },
        { kind: "p", text: "Depending on your individual results, your Action Plan may include:" },
        { kind: "li", text: "Personalised insights based on your Visibility Codes assessment results." },
        { kind: "li", text: "Practical action steps based on the areas identified through your assessment." },
        { kind: "li", text: "Guidance to help strengthen your visibility, positioning, recognition, consistency, connection and opportunity creation." },
        { kind: "li", text: "Exercises, prompts and recommendations to help you take action." },
        { kind: "li", text: "Any additional digital resources specifically stated on the checkout page at the time of purchase." },
        { kind: "p", text: "Your Action Plan is provided for your personal use only and cannot be shared, transferred or resold." },
      ],
    },
    {
      heading: "Digital Product Delivery",
      blocks: [
        { kind: "p", text: "The Visibility Codes Personalised Action Plan is a digital product." },
        { kind: "p", text: "Your Action Plan may be delivered by email, digital download, online access or another electronic method communicated to you following purchase." },
        { kind: "p", text: "You are responsible for providing a valid and accurate email address at checkout and for ensuring you can receive communications relating to your purchase." },
        { kind: "p", text: "If you experience a genuine issue receiving or accessing your Action Plan, please contact us so we can assist you." },
      ],
    },
    {
      heading: "Payments and Refunds",
      blocks: [
        { kind: "p", text: "All prices are displayed in the currency stated on the checkout page and are payable at the time of purchase." },
        { kind: "p", text: "Because this is a digital product supplied in connection with your individual Visibility Codes assessment results, we do not provide refunds for change of mind once your Action Plan has been delivered or access has been provided." },
        { kind: "p", text: "Choosing not to download, open, read, complete or implement your Action Plan does not entitle you to a full or partial refund." },
        { kind: "p", text: "If there is a genuine fault with your purchase, your Action Plan is not supplied as described, or you are otherwise entitled to a remedy under applicable consumer law, please contact us so we can address the issue." },
        { kind: "p", text: "Nothing in these Terms excludes, restricts or modifies any consumer guarantee, right or remedy that cannot lawfully be excluded under the Australian Consumer Law." },
      ],
    },
    {
      heading: "Intellectual Property",
      blocks: [
        { kind: "p", text: "All content associated with The Visibility Codes is protected intellectual property." },
        { kind: "p", text: "This includes, without limitation:" },
        { kind: "li", text: "The Visibility Codes name, concept and methodology." },
        { kind: "li", text: "The Visibility Codes assessment and quiz." },
        { kind: "li", text: "Assessment questions." },
        { kind: "li", text: "Scoring methodologies." },
        { kind: "li", text: "Results categories and profiles." },
        { kind: "li", text: "Personalised Action Plans." },
        { kind: "li", text: "Frameworks." },
        { kind: "li", text: "Strategies." },
        { kind: "li", text: "Exercises." },
        { kind: "li", text: "Prompts." },
        { kind: "li", text: "Recommendations." },
        { kind: "li", text: "Written materials." },
        { kind: "li", text: "Templates." },
        { kind: "li", text: "Guides." },
        { kind: "li", text: "Graphics and designs." },
        { kind: "li", text: "Processes and systems." },
        { kind: "li", text: "Educational content." },
        { kind: "li", text: "Related digital resources." },
        { kind: "p", text: "This also includes the proprietary concepts and frameworks associated with The Visibility Codes, including North Star, Magnetic Advantage, Strategic Proximity and Created Luck." },
        { kind: "p", text: "Your purchase gives you a limited, personal, non exclusive and non transferable right to use your Action Plan for your own personal, professional or business development." },
        { kind: "p", text: "You may apply the recommendations and strategies you learn to your own personal brand, career or business." },
        { kind: "p", text: "You may not copy, reproduce, distribute, publish, upload, share, sell, license, teach, repurpose, commercially exploit or make our materials available to another person without prior written permission." },
        { kind: "p", text: "You may not reproduce or adapt The Visibility Codes assessment, questions, scoring methodology, Action Plans, frameworks or proprietary materials for use with your own clients, customers, audience, students or community." },
        { kind: "p", text: "You may not use The Visibility Codes intellectual property to create or assist in creating a competing assessment, quiz, program, course, membership, coaching service, digital product, software product, artificial intelligence product or other commercial offering." },
        { kind: "p", text: "You may not upload our proprietary materials into artificial intelligence platforms or other systems for the purpose of extracting, reproducing, reverse engineering, replicating or creating derivative products from our intellectual property." },
        { kind: "p", text: "Purchasing an Action Plan does not transfer ownership of any intellectual property to you." },
      ],
    },
    {
      heading: "Personal Use",
      blocks: [
        { kind: "p", text: "Your Visibility Codes Action Plan is provided specifically for you based on your assessment results." },
        { kind: "p", text: "You may use the information and recommendations contained within it to support your own personal brand, career or business." },
        { kind: "p", text: "You may not:" },
        { kind: "li", text: "Give or sell your Action Plan to another person." },
        { kind: "li", text: "Upload the complete Action Plan publicly." },
        { kind: "li", text: "Reproduce or distribute it to an audience, group, membership or community." },
        { kind: "li", text: "Use it as training material for your own clients or customers." },
        { kind: "li", text: "Sell, license or commercially distribute any part of it." },
        { kind: "li", text: "Present The Visibility Codes materials, frameworks or methodology as your own." },
      ],
    },
    {
      heading: "Information you provide",
      blocks: [
        { kind: "p", text: "Your Visibility Codes results and Personalised Action Plan are based on the information and responses you provide through the assessment." },
        { kind: "p", text: "You are responsible for answering the assessment accurately and honestly." },
        { kind: "p", text: "Your results and recommendations are based on the information available to us through your responses." },
        { kind: "p", text: "If your responses are incomplete or inaccurate, your results and recommendations may not accurately reflect your circumstances." },
      ],
    },
    {
      heading: "Results Disclaimer",
      blocks: [
        { kind: "p", text: "The Visibility Codes Personalised Action Plan is designed to provide education, strategy, guidance and practical recommendations relating to visibility, personal branding, positioning, recognition and opportunity creation." },
        { kind: "p", text: "Individual results will vary." },
        { kind: "p", text: "No specific result or outcome is guaranteed." },
        { kind: "p", text: "This includes, without limitation, any guarantee relating to:" },
        { kind: "li", text: "Followers or audience growth." },
        { kind: "li", text: "Social media performance." },
        { kind: "li", text: "Viral content." },
        { kind: "li", text: "Increased visibility." },
        { kind: "li", text: "Media coverage." },
        { kind: "li", text: "Speaking opportunities." },
        { kind: "li", text: "Partnerships or collaborations." },
        { kind: "li", text: "Brand opportunities." },
        { kind: "li", text: "Clients or customers." },
        { kind: "li", text: "Revenue or profit." },
        { kind: "li", text: "Career opportunities." },
        { kind: "li", text: "Public recognition." },
        { kind: "li", text: "Business growth." },
        { kind: "li", text: "Financial results." },
        { kind: "p", text: "Your results depend on numerous factors, including your starting position, circumstances, experience, industry, market, audience, decisions, implementation, consistency and effort." },
        { kind: "p", text: "The Visibility Codes provides you with insights, recommendations and strategies. You remain responsible for the decisions you make, the actions you take and the results you achieve." },
      ],
    },
    {
      heading: "Educational Purposes",
      blocks: [
        { kind: "p", text: "The Visibility Codes assessment and Personalised Action Plan are provided for educational and informational purposes." },
        { kind: "p", text: "Nothing contained within your results, Action Plan or related materials constitutes personalised legal, financial, accounting, tax, medical, psychological or investment advice." },
        { kind: "p", text: "You should seek appropriately qualified professional advice where your individual circumstances require it." },
      ],
    },
    {
      heading: "Third Party Platforms and Technology",
      blocks: [
        { kind: "p", text: "We may use third party platforms and service providers to process payments, collect assessment responses, generate or deliver your Action Plan, send emails or provide other technology required to fulfil your purchase." },
        { kind: "p", text: "We are not responsible for temporary outages or technical interruptions caused by third party platforms that are outside our reasonable control." },
        { kind: "p", text: "If a genuine technical issue prevents you from receiving a product you have purchased, please contact us so we can reasonably assist." },
      ],
    },
    {
      heading: "Waitlist and Future Offers",
      blocks: [
        { kind: "p", text: "Your purchase of The Visibility Codes Personalised Action Plan is separate from any future masterclass, program, product or service." },
        { kind: "p", text: "Purchasing your Action Plan does not require you to purchase or participate in anything further." },
        { kind: "p", text: "If you separately choose to join The Visibility Codes Masterclass priority waitlist, or otherwise opt in to receive marketing communications from us, we may send you information relating to The Visibility Codes Masterclass, future programs, products, offers and related updates." },
        { kind: "p", text: "You may unsubscribe from marketing communications at any time." },
        { kind: "p", text: "Unsubscribing from marketing communications will not prevent us from sending transactional communications that are reasonably necessary to fulfil or support an existing purchase." },
      ],
    },
    {
      heading: "Your Details",
      blocks: [
        { kind: "p", text: "Your details and assessment responses are used to process your purchase, deliver your personalised Visibility Codes Action Plan, provide customer support and send you communications directly related to your purchase, as described in our Privacy Policy." },
        { kind: "p", text: "If you have separately chosen to join The Visibility Codes Masterclass priority waitlist or opted in to receive marketing communications, we may also send you information about The Visibility Codes Masterclass, future programs, products, offers and related updates." },
        { kind: "p", text: "You can unsubscribe from marketing communications at any time." },
        { kind: "p", text: "Your personal information will be handled in accordance with our Privacy Policy and applicable privacy laws." },
        { kind: "p", text: "If you have any questions about your purchase, please contact us at info@katrinakavvalos.com" },
        { kind: "p", text: "By proceeding with your purchase, you confirm that you have read, understood and agree to these Terms of Purchase." },
      ],
    },
  ],
};
